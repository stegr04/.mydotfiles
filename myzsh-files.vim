...
set runtimepath=~/.vim,~/.vim/bundle/Vundle.vim,~/.vim/bundle/nerdtree,~/.vim/bundle/bash-support,~/.vim/bundle/vim-surround,/usr/local/Cellar/macvim/8.1-151/MacVim.app/Contents/Resources/vim/vimfiles,/usr/local/Cellar/macvim/8.1-151/MacVim.app/Contents/Resources/vim/runtime,/usr/local/Cellar/macvim/8.1-151/MacVim.app/Contents/Resources/vim/vimfiles/after,~/.vim/after,~/.mydotfiles/plugins/vim/.vim/bundle/Vundle.vim,~/.vim/bundle/Vundle.vim/after,~/.vim/bundle/nerdtree/after,~/.vim/bundle/bash-support/after,~/.vim/bundle/vim-surround/after
...
set shortmess=aoO
badd +1 ~/.zshrc
badd +10 plugins/mybin/mybin.plugin.zsh
badd +1 plugins/myzsh/.zshrc
badd +1 plugins/myzsh/myzsh.plugin.zsh
badd +1 plugins/releaseauto/releaseauto.plugin.zsh
badd +1 plugins/vim/.vimrc
badd +5 plugins/vim/vim.plugin.zsh
argglobal
silent! argdel *
$argadd ~/.zshrc
set stal=2
...
normal! 0
tabnext
edit plugins/vim/vim.plugin.zsh
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
